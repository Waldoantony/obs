...
// bgImage  = background photo/art shown behind the spotlight number when
//            this state is featured in the center panel. Put your own image
//            in an "images/" folder next to index.html and point to it here,
//            e.g. "images/ny-skyline.jpg". Leave "" to use the plain dark
//            background (no photo) for that state.
// fields   = the rows shown for that state, in order
const STATE_CONFIG = [
  { key: "NY", name: "New York",    icon: "🗽", color: "#9b5de5", bgImage: "", fields: [
      { key: "matin", label: "Matin" },
      { key: "soir",  label: "Soir"  }
  ]},
  { key: "GA", name: "Georgia",     icon: "🍑", color: "#22c55e", bgImage: "", fields: [
      { key: "matin", label: "Matin" },
      { key: "soir",  label: "Soir"  }
  ]},
  { key: "FL", name: "Florida",     icon: "🌴", color: "#ef4444", bgImage: "", fields: [
      { key: "matin", label: "Maten" },
      { key: "soir",  label: "Soir"  }
  ]},
  { key: "NJ", name: "New Jersey",  icon: "🌻", color: "#1d4ed8", bgImage: "", fields: [
      { key: "matin", label: "Maten" },
      { key: "soir",  label: "Soir"  }
  ]},
  { key: "TN", name: "Tennessee",   icon: "🎸", color: "#9b5de5", bgImage: "", fields: [
      { key: "matin", label: "Maten" },
      { key: "h1h20", label: "1H20"  },
      { key: "soir",  label: "Soir"  }
  ]},
  { key: "TX", name: "Texas",       icon: "🤠", color: "#3a86ff", bgImage: "", fields: [
      { key: "matin", label: "Maten" },
      { key: "h1h30", label: "1H30"  },
      { key: "soir",  label: "Soir"  }
  ]},
  { key: "MD", name: "Maryland",    icon: "🦀", color: "#06b6d4", bgImage: "", fields: [
      { key: "matin", label: "Maten" },
      { key: "soir",  label: "Soir"  }
  ]}
];
